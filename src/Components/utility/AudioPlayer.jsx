...
function AudioPlayer({ className }) {
	return (
		<div
			className={`mx-auto h-[110px] rounded-full flex flex-row items-center w-full max-w-[390px] border border-info sm:max-w-[360px] md:max-w-[520px] lg:max-w-[620px] xl:max-w-[720px] ${className}`}
		>
			<img
